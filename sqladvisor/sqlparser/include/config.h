...
#define DEFAULT_MYSQL_HOME "/usr/local/sqlparser"
#define SHAREDIR "/usr/local/sqlparser/share"
#define DEFAULT_BASEDIR "/usr/local/sqlparser"
#define MYSQL_DATADIR "/usr/local/sqlparser/data"
#define DEFAULT_CHARSET_HOME "/usr/local/sqlparser"
#define PLUGINDIR "/usr/local/sqlparser/lib/mysql/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/sqlparser/etc"
...
#define MYSQL_VERSION_EXTRA "-72.1"

#define PACKAGE "mysql"
#define PACKAGE_BUGREPORT ""
#define PACKAGE_NAME "MySQL Server"
#define PACKAGE_STRING "MySQL Server 5.6.23-72.1"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.6.23-72.1"
#define VERSION "5.6.23-72.1"
